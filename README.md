...
For detailed setup instructions, see [INSTALLATION_GUIDE.md](./docs/INSTALLATION_GUIDE.md)
...
Full guide: See [HOW_TO_USE_GUIDE.md](./docs/HOW_TO_USE_GUIDE.md) - Section 3.2
...
Full guide: See [HOW_TO_USE_GUIDE.md](./docs/HOW_TO_USE_GUIDE.md) - Sections 3.1 and 4.3-4.4
...
See [FUTURE_WORK_ROADMAP.md](./docs/FUTURE_WORK_ROADMAP.md) - Phase 1 for implementation details
...
See [FUTURE_WORK_ROADMAP.md](./docs/FUTURE_WORK_ROADMAP.md) for plans to address limitations.
...
**Full roadmap with budgets and timelines:** See [FUTURE_WORK_ROADMAP.md](./docs/FUTURE_WORK_ROADMAP.md)

## Support

### Getting Help

1. **Check the documentation:** Most questions answered in [TROUBLESHOOTING_GUIDE.md](./docs/TROUBLESHOOTING_GUIDE.md)
2. **Review examples:** See [HOW_TO_USE_GUIDE.md](./docs/HOW_TO_USE_GUIDE.md) for workflows
3. **Check known issues:** See [GitHub Issues](https://github.com/FIU-CIS-Capstone/SecureMed/issues) section
...
3. [Open a GitHub Issue](https://github.com/FIU-CIS-Capstone/SecureMed/issues)

### Asking Questions

- Use [GitHub Discussions](https://github.com/FIU-CIS-Capstone/SecureMed/discussions) for general questions
...
- **GitHub:** https://github.com/FIU-CIS-Capstone/SecureMed
- **Documentation:** See files in `/docs` directory
- **Issues:** [GitHub Issues](https://github.com/FIU-CIS-Capstone/SecureMed/issues)
- **Questions:** [GitHub Discussions](https://github.com/FIU-CIS-Capstone/SecureMed/discussions)
...
→ [Features Overview](./docs/FEATURES_SYSTEM_OVERVIEW.md)  
→ [Deployment Planning](./docs/FUTURE_WORK_ROADMAP.md)
